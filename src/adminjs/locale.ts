...
export const locale: Locale = {
  language: 'pt-BR',
  translations: {
    //açoes do painel administrativo
    actions: {
      new: 'Criar novo(a)',
      edit: 'Editar',
      show: 'Exibir',
    ...
    //textos da interface incluindo os nomes das abas criadas como users
    labels: {
    ...
    // propriedades usadas nos inputs
    properties: {
    ...
    //mensagens que o adminjs exibe na tela , como avisos por exemplo
    messages: {
