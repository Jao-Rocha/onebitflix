...
module.exports = {
  async up(queryInterface, Sequelize) {
    //para pegar a chave estrangeira que sera referenciado o curso, abaixo ele seleciona todos os ids da tabela categories e retorna no formato de array
    ...
    await queryInterface.bulkInsert('courses', [
      {
        ...
        featured: true,
        //pegando o id da primeira categoria na posiçao 1 do array
